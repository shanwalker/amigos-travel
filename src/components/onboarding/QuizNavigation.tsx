    ...
    return (
        <div className={cn("flex items-center justify-between gap-2.5", className)}>
            ...
            <motion.button
                ...
                className={cn(
                    "flex items-center gap-1.5 px-4 py-2.5 rounded-xl font-medium transition-all duration-300",
                    canGoPrev && !isLoading
            ...
            {showSkip && onSkip && (
                <button
                    onClick={onSkip}
                    disabled={isLoading}
                    className="text-xs sm:text-sm text-white/50 hover:text-white/80 transition-colors underline-offset-4 hover:underline"
                >
                    Skip
                </button>
            )}
            ...
            <motion.button
                ...
                className={cn(
                    "flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm sm:text-base transition-all duration-300",
                    canGoNext && !isLoading
